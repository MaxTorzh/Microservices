...
const file_user_user_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x05 \x01(\tR\tupdatedAt2\xbd\x02\n" +
	"\vUserService\x129\n" +
	"\n" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB\x15Z\x13gRPC/api/proto/userb\x06proto3"
...
var file_user_user_proto_depIdxs = []int32{
	...
	7, // 6: user.UserService.CreateUser:output_type -> user.UserResponse
	...
	7, // 9: user.UserService.UpdateUser:output_type -> user.UserResponse
